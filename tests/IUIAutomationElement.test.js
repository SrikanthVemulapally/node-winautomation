const { AutomationStructureChangedEventHandler, ExpandCollapseStates, ScrollAmounts, SupportedTextSelections, WindowVisualStates, WindowInteractionStates } = require('node-winautomation');
const { Automation, TreeScopes, PropertyIds, ElementModes, PatternIds, DockPositions, ControlTypeIds, ToggleStates } = require('node-winautomation');
